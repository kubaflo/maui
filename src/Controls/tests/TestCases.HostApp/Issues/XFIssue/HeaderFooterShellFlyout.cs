		...
		Items.Add(new MenuItem()
		{
			...
			Command = new Command(() =>
			{
				...
				else
				{
					...
					{
						// Issue #26395: Footer was not rendering correctly when horizontal orientation was set. 
						// This has been fixed by accounting for SafeAreaInsets.Bottom in ShellFlyoutContentRenderer.
