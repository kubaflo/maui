...
The skill checks issue bodies for:

| Signal | Score | What It Means |
|--------|-------|---------------|
| Code blocks (```) | +3 | Has code reproduction |
| Numbered steps | +3 | Has step-by-step repro |
| XAML content | +2 | Has XAML sample |
| Expected/Actual | +2 | Clear behavior description |
| Screenshots | +1 | Visual evidence |
| Stack trace | +1 | Error information |
| Version info | +1 | .NET/MAUI version specified |
| Long description (500+ chars) | +1 | Detailed report |
| Very short (<100 chars) | -2 | Insufficient information |

**Quality levels:**
- **good** (6+): Has thorough reproduction
- **fair** (3-5): Has some reproduction info
- **weak** (1-2): Description only, no code or steps
